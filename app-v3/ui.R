            ...
            navbarPage(title="QSIDE SToPA (Small Town Policing Accountability) Application", id = "tabs",
                       ...
                       tabPanel("About",
                                ...
                                HTML(paste0(
                                  ...
                                  "<li>On the upper lefthand side of the screen, click the “Sample Dataset” button, which will automatically populate a majority of the page. PLEASE NOTE THIS DATASET IS COMPOSED OF SYNTHETIC DATA. THIS IS NOT REPRRSENTATIVE OF REAL POLICING DATA FROM DURHAM, NC.</li>",
