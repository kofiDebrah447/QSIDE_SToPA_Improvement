      ...
      expr = {
        ...
        if (all(c("Patrol", "Race") %in% colnames(policingdata))) {
          ...
          modifiedqdata$Race <- dplyr::recode(modifiedqdata$Race,
                                              `3` = "White",  
                                              `6` = "Black", 
                                              .default = "AIAN, Asian, Hispanic/Latino, NHPI, Multiracial (Combined)") 
         
           modifiedqdata$Race <- factor(str_wrap(modifiedqdata$Race, width = 30))
        ...
        if (all(c("Officer", "Race") %in% colnames(policingdata))) {
          ...
          modified9qdata$Race <- factor(str_wrap(modified9qdata$Race, width = 30))
