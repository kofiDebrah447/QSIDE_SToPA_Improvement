...
### For the Q3, the race, gender, and druggun variables must be available to answer the question. If there is missing data in these columns, filter them out. 

### For this situation, we want to answer the question: What proportion of incidents related to drug and/or firearm possession go to different gender/race groups?
