...
### For the Q1, the race and gender variables must be available to answer the question. If there is missing data in these columns, filter them out. 

### For this situation, we want to answer the question: What proportion of all police incidents go to different gender/race groups? 
